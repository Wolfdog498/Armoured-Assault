...
('UNIT_MOUNTED_CROSSBOW',	'UNITAI_COMBAT'),
('UNIT_MOUNTED_CROSSBOW',	'UNITAI_EXPLORE'),
...
(Type,						Tag)
VALUES
('UNIT_ASSAULT_GUN',		'CLASS_AUTOMATIC_GUN'),
('UNIT_ASSAULT_GUN',		'CLASS_RANGED_CAVALRY'),
('UNIT_SP_GUN',				'CLASS_RANGED_CAVALRY'),
('UNIT_TANK_DESTROYER',		'CLASS_ANTI_CAVALRY'),
('UNIT_TANK_DESTROYER',		'CLASS_RANGED_CAVALRY'),
('UNIT_LANCER',				'CLASS_ANTI_CAVALRY'),
('UNIT_LANCER',				'CLASS_LIGHT_CAVALRY'),
('UNIT_ARMORED_CAR',		'CLASS_AUTOMATIC_GUN'),
('UNIT_ARMORED_CAR',		'CLASS_RANGED_CAVALRY'),
...
('UNIT_MODERN_TANK_DEST',	'CLASS_RANGED_CAVALRY'),
('UNIT_SP_HOWITZER',		'CLASS_RANGED_CAVALRY'),
('UNIT_HORSE_ARCHER',		'CLASS_RANGED_CAVALRY'),
('UNIT_HORSE_ARCHER',		'CLASS_MOBILE_RANGED'),
('UNIT_CHARIOT_ARCHER',		'CLASS_LIGHT_CHARIOT'),
('UNIT_HORSE_ARTILLERY',	'CLASS_RANGED_CAVALRY'),
('UNIT_HORSE_ARTILLERY',	'CLASS_MOBILE_RANGED'),
...
('UNIT_MOBILE_GUN_SYSTEM',	'CLASS_RANGED_CAVALRY'),
('UNIT_MOBILE_AAA',			'CLASS_ANTI_AIR'),
('UNIT_MOUNTED_CROSSBOW',	'CLASS_RANGED_CAVALRY'),
('UNIT_MOUNTED_CROSSBOW',	'CLASS_MOBILE_RANGED'),
('UNIT_HARQUEBUSIER',		'CLASS_RANGED_CAVALRY'),
('UNIT_HARQUEBUSIER',		'CLASS_MOBILE_RANGED');
...
VALUES
('UNIT_ASSAULT_GUN',		4,			510,	'ADVISOR_CONQUEST',	2,				'0',			'DOMAIN_LAND',	'FORMATION_CLASS_LAND_COMBAT',	'LOC_UNIT_ASSAULT_GUN_NAME',		'LOC_UNIT_ASSAULT_GUN_DESCRIPTION',			'YIELD_GOLD',	null,				'PROMOTION_CLASS_AUTOMATIC_GUN',	6,				68,		72,				1,		0,			'RESOURCE_OIL',		'TECH_ADVANCED_BALLISTICS',	'TECH_TELECOMMUNICATIONS',	'0',			60,				0,			'0',			'0',		null,					'1',		'0'),
...
('UNIT_MOBILE_AAA',			4,			520,	'ADVISOR_CONQUEST',	2,				'0',			'DOMAIN_LAND',	'FORMATION_CLASS_SUPPORT',		'LOC_UNIT_MOBILE_AAA_NAME',			'LOC_UNIT_MOBILE_AAA_DESCRIPTION',			'YIELD_GOLD',	null,				'PROMOTION_CLASS_SUPPORT',			6,				0,		0,				1,		0,			'RESOURCE_OIL',		'TECH_SYNTHETIC_MATERIALS',	null,						'0',			90,				0,			'0',			'0',		null,					'1',		'0'),
('UNIT_MOUNTED_CROSSBOW',	4,			200,	'ADVISOR_CONQUEST',	2,				'0',			'DOMAIN_LAND',	'FORMATION_CLASS_LAND_COMBAT',	'LOC_UNIT_MOUNTED_CROSSBOW_NAME',	'LOC_UNIT_MOUNTED_CROSSBOW_DESCRIPTION',	'YIELD_GOLD',	null,				'PROMOTION_CLASS_RANGED',			3,				30,		40,				2,		0,			'RESOURCE_HORSES',	'TECH_STIRRUPS',			'TECH_GUNPOWDER',			'0',			0,				0,			'0',			'0',		null,					'1',		'0'),
('UNIT_HARQUEBUSIER',		4,			275,	'ADVISOR_CONQUEST',	2,				'0',			'DOMAIN_LAND',	'FORMATION_CLASS_LAND_COMBAT',	'LOC_UNIT_HARQUEBUSIER_NAME',		'LOC_UNIT_HARQUEBUSIER_DESCRIPTION',		'YIELD_GOLD',	null,				'PROMOTION_CLASS_RANGED',			4,				40,		50,				2,		0,			'RESOURCE_NITER',	'TECH_GUNPOWDER',			'TECH_BALLISTICS',			'0',			0,				0,			'0',			'0',		null,					'1',		'0');

UPDATE Units SET Combat = 22, RangedCombat = 36, Range = 2
WHERE UnitType = 'UNIT_SCYTHIAN_HORSE_ARCHER';

UPDATE Units SET PrereqTech = 'TECH_RADIO'
WHERE UnitType = 'UNIT_ANTIAIR_GUN';

UPDATE Units SET BaseMoves = 4, Range = 2
WHERE UnitType = 'UNIT_MOBILE_SAM';

UPDATE Units SET AntiAirCombat = 95
WHERE UnitType = 'UNIT_MOBILE_AAA' AND NOT EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_COURSER');
...
VALUES
('UNIT_ASSAULT_GUN',		1,							1,				'RESOURCE_OIL',				0,				1,					0,						1,							0),
('UNIT_SP_GUN',				1,							1,				'RESOURCE_OIL',				0,				1,					0,						1,							0),
('UNIT_TANK_DESTROYER',		1,							1,				'RESOURCE_OIL',				0,				1,					0,						1,							0),
('UNIT_ARMORED_CAR',		1,							1,				'RESOURCE_OIL',				0,				1,					0,						1,							0),
('UNIT_LIGHT_TANK',			1,							1,				'RESOURCE_OIL',				0,				1,					0,						1,							0),
('UNIT_MODERN_TANK_DEST',	1,							1,				'RESOURCE_OIL',				0,				1,					0,						1,							0),
('UNIT_SP_HOWITZER',		1,							1,				'RESOURCE_OIL',				0,				1,					0,						1,							0),
('UNIT_EARLY_LIGHT_TANK',	1,							1,				'RESOURCE_OIL',				0,				1,					0,						1,							0),
('UNIT_ARMORED_CAVALRY',	1,							1,				'RESOURCE_OIL',				0,				1,					0,						1,							0),
('UNIT_MOBILE_GUN_SYSTEM',	1,							1,				'RESOURCE_OIL',				0,				1,					0,						1,							0),
('UNIT_MOBILE_AAA',			0,							0,				NULL,						0,				0,					0,						0,							0),
('UNIT_LANCER',				0,							20,				NULL,						0,				1,					0,						1,							0),
('UNIT_CHARIOT_ARCHER',		0,							20,				NULL,						0,				1,					0,						1,							0),
('UNIT_HORSE_ARCHER',		0,							20,				NULL,						0,				1,					0,						1,							0),
('UNIT_HORSE_ARTILLERY',	0,							20,				NULL,						0,				1,					0,						1,							0),
('UNIT_MOUNTED_CROSSBOW',	0,							20,				NULL,						0,				1,					0,						1,							0),
...
(Unit,						UpgradeUnit)
VALUES
('UNIT_HORSE_ARTILLERY',	'UNIT_SP_HOWITZER'),
...
('UNIT_MOUNTED_CROSSBOW',	'UNIT_HARQUEBUSIER'),
('UNIT_HARQUEBUSIER',		'UNIT_HORSE_ARTILLERY');

UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_MOBILE_AAA'
WHERE Unit = 'UNIT_ANTIAIR_GUN';

UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_HARQUEBUSIER'
WHERE Unit = 'UNIT_MONGOLIAN_KESHIG' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_MONGOLIAN_KESHIG');

UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_HORSE_ARCHER'
WHERE Unit = 'UNIT_EGYPTIAN_CHARIOT_ARCHER';

UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_MOUNTED_CROSSBOW'
...
(CivUniqueUnitType,			ReplacesUnitType)
SELECT
'UNIT_MONGOLIAN_KESHIG',	'UNIT_MOUNTED_CROSSBOW'
WHERE EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_MONGOLIAN_KESHIG');

UPDATE UnitReplaces SET ReplacesUnitType = 'UNIT_CHARIOT_ARCHER'
WHERE CivUniqueUnitType = 'UNIT_EGYPTIAN_CHARIOT_ARCHER';

------------------------------------------
-- Steel & Thunder Unique Units Changes --
------------------------------------------
-- UNIT_ARABIAN_CAMEL_ARCHER
UPDATE Units SET Combat = 22, RangedCombat = 35, Range = 2
WHERE UnitType = 'UNIT_ARABIAN_CAMEL_ARCHER' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_ARABIAN_CAMEL_ARCHER');

UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_HARQUEBUSIER'
WHERE Unit = 'UNIT_ARABIAN_CAMEL_ARCHER' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_ARABIAN_CAMEL_ARCHER');

INSERT INTO UnitReplaces
(CivUniqueUnitType,				ReplacesUnitType)
SELECT
'UNIT_ARABIAN_CAMEL_ARCHER',	'UNIT_HORSE_ARCHER'
...
WHERE UnitType = 'UNIT_HUNGARY_KALANDOZO' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_HUNGARY_KALANDOZO');

UPDATE UnitUpgrades SET UpgradeUnit = 'UNIT_HARQUEBUSIER'
WHERE Unit = 'UNIT_HUNGARY_KALANDOZO' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_HUNGARY_KALANDOZO');

UPDATE UnitReplaces SET ReplacesUnitType = 'UNIT_MOUNTED_CROSSBOW'
WHERE CivUniqueUnitType = 'UNIT_HUNGARY_KALANDOZO' AND EXISTS (SELECT 1 FROM Units WHERE UnitType = 'UNIT_HUNGARY_KALANDOZO');
